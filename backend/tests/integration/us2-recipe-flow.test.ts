...
describe('US2: recipe browse and step-through', () => {
  ...
  beforeAll(async () => {
    db.exec(`
      ...
      INSERT INTO plants (id, name, qr_code, benefit_text, is_published) VALUES (1, 'Carrot', 'QR-CARROT-01', 'Sees in the dark', 1);
      INSERT INTO recipes (id, name, is_published) VALUES (1, 'Carrot Soup', 1);
      INSERT INTO recipes (id, name, is_published) VALUES (2, 'Draft Carrot Cake', 0);
